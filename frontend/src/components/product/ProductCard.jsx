  ...
  return (
    <div key={_id} className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
      ...
      <div href={`/productdetail/${_id}`}>
        <img  className="mx-auto w-72 h-72 rounded-lg shadow-xl hover:shadow-2xl" src={images.secure_url} alt={name} />
        <div className="pt-3 grid col-end-1">
          <a href={`/productdetail/${_id}`} className="mx-auto font-semibold">{name}</a>
        ...
        <button
          className="mx-auto px-8 py-2 bg-blue-600 text-white text-sm font-medium rounded hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500 flex items-center"
